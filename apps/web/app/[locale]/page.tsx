        ...
        <section className="text-center py-20 relative">
          ...
          <div className="flex justify-center mb-8 relative">
            <div className="relative">
              ...
              <div className="relative bg-white/5 backdrop-blur-sm rounded-full p-4 border border-white/10">
                <Image
                  src="/logo.svg"
                  alt="IT-TMS Logo"
                  width={80}
                  height={80}
                  className="h-20 w-20 animate-spin-slow opacity-80"
                />
              </div>
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex justify-center items-center gap-2 mb-6">
              <Sparkles className="text-blue-500/70 animate-spin" size={24} />
              <Zap className="text-purple-500/70 animate-bounce" size={24} />
              <Star className="text-blue-600/70 animate-pulse" size={24} />
              <Rocket className="text-purple-600/70 animate-bounce" size={24} />
            </div>
          </div>
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {user ? (
              <Button 
                ...
                color="primary" 
                size="lg"
                className="px-10 py-6 text-lg font-semibold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl animate-pulse-slow"
              >
            ...
            <Button 
              ...
              variant="bordered" 
              size="lg"
              className="px-10 py-6 text-lg font-semibold border-2 border-white/20 hover:border-white/40 bg-white/5 hover:bg-white/10 transform hover:scale-105 transition-all duration-300 backdrop-blur-sm"
            >
        ...
        <section className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {cards.map((card, index) => (
              <Card 
                key={card.href} 
                className={`glass hover:scale-105 transition-all duration-500 group cursor-pointer p-6 border border-white/5 hover:border-white/15 backdrop-blur-lg hover:shadow-2xl hover:shadow-purple-600/10 animate-fade-in-up ${card.delay} ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                isPressable
                as={Link}
              ...
              >
                <CardHeader className="flex flex-col items-center text-center pb-4">
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-purple-500 group-hover:bg-clip-text transition-all duration-300">
                    {card.title}
                  </h3>
                </CardHeader>
                <CardBody className="text-center pt-0">
                  <p className="text-sm text-white/50 mb-6 group-hover:text-white/70 transition-colors duration-300">
                    {card.desc}
                  </p>
                  <Button 
                    color="primary" 
                    variant="flat" 
                    size="sm"
                    className="w-full bg-gradient-to-r from-blue-600/10 to-purple-600/10 hover:from-blue-600/20 hover:to-purple-600/20 border border-white/10 hover:border-white/20 transition-all duration-300 group-hover:scale-105"
                  >
                    {tCommon('go')}
                  </Button>
                </CardBody>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-12 max-w-4xl mx-auto transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="text-center group">
              <div className="relative mb-4">
                <div className="text-5xl md:text-6xl font-bold text-transparent bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text animate-counter">
                  99.9%
                </div>
                <div className="absolute inset-0 text-5xl md:text-6xl font-bold text-blue-500/10 blur-sm animate-pulse">
                  99.9%
                </div>
              </div>
              <div className="text-white/50 text-lg font-medium group-hover:text-white/70 transition-colors duration-300">
                {tCommon('uptime')}
              </div>
            </div>
            <div className="text-center group">
              <div className="relative mb-4">
                <div className="text-5xl md:text-6xl font-bold text-transparent bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text animate-counter">
                  &lt;2min
                </div>
                <div className="absolute inset-0 text-5xl md:text-6xl font-bold text-purple-500/10 blur-sm animate-pulse">
                  &lt;2min
                </div>
              </div>
              <div className="text-white/50 text-lg font-medium group-hover:text-white/70 transition-colors duration-300">
            ...
            <div className="text-center group">
              <div className="relative mb-4">
                <div className="text-5xl md:text-6xl font-bold text-transparent bg-gradient-to-r from-slate-400 to-blue-500 bg-clip-text animate-counter">
                  24/7
                </div>
                <div className="absolute inset-0 text-5xl md:text-6xl font-bold text-slate-400/10 blur-sm animate-pulse">
                  24/7
                </div>
              </div>
              <div className="text-white/50 text-lg font-medium group-hover:text-white/70 transition-colors duration-300">
